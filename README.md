...
Лицензия: [MIT](LICENSE). Готовый пакет для установки — в [Releases](https://github.com/Alexandr-GitHub/goldprice/releases): `goldprice-1.1.1-pl.transport.zip`.
...
1. Скачайте `goldprice-1.1.1-pl.transport.zip` из релиза.
...
goldprice-1.1.1-pl.transport.zip # готовый пакет (также в GitHub Release)
```

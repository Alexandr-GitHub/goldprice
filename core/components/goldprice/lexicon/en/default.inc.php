...
$_lang['goldprice.field_subgroup'] = 'Subgroup (series)';
$_lang['goldprice.field_subgroup_help'] = 'Optional. Markup deltas are added to the selected weight group.';
...
$_lang['goldprice.tab_groups_intro'] = 'Weight groups and pricing subgroups (series). Subgroups only store markup deltas. Prices are recalculated after any change.';
...
$_lang['goldprice.tab_trash'] = 'Trash';
$_lang['goldprice.tab_trash_intro'] = 'Deleted weight groups and subgroups. Restore or delete permanently.';
...
$_lang['goldprice.group_add_to_parent'] = 'Add to parent group markups';
$_lang['goldprice.group_add_to_parent_desc'] = 'On — subgroup markups are added to the parent group; min. margin comes from the parent. Off — subgroup uses its own full markups and min. margin.';
$_lang['goldprice.group_parent'] = 'Weight group';
$_lang['goldprice.group_root_create'] = 'Add weight group';
$_lang['goldprice.group_subgroup_create'] = 'Add subgroup';
$_lang['goldprice.group_root_update'] = 'Edit weight group';
$_lang['goldprice.group_subgroup_update'] = 'Edit subgroup';
$_lang['goldprice.group_copy'] = 'Copy';
$_lang['goldprice.group_copy_suffix'] = ' (copy)';
$_lang['goldprice.group_remove'] = 'Delete';
$_lang['goldprice.group_subgroup_remove'] = 'Remove subgroup';
$_lang['goldprice.group_subgroup_remove_confirm'] = 'Products in this subgroup will be moved to the parent weight group. Delete the subgroup?';
$_lang['goldprice.group_root_remove_confirm'] = 'The weight group, its subgroups, and their products will be moved to trash. Products will be unassigned. Delete?';
$_lang['goldprice.group_deleted_at'] = 'Deleted at';
$_lang['goldprice.group_restore'] = 'Restore';
$_lang['goldprice.group_restore_confirm'] = 'Restore this group? Restoring a weight group also restores its deleted subgroups.';
$_lang['goldprice.group_purge'] = 'Delete permanently';
$_lang['goldprice.group_subgroup_purge_confirm'] = 'The subgroup will be permanently deleted. Products move to the parent group if it is active. Continue?';
$_lang['goldprice.group_root_purge_confirm'] = 'The weight group and its subgroups will be permanently deleted. Products will be unassigned. Continue?';
...
$_lang['goldprice.err_group_parent'] = 'Select a weight group for the subgroup.';
$_lang['goldprice.err_group_remove_root'] = 'Weight groups cannot be removed.';
$_lang['goldprice.err_group_deleted'] = 'Group is in trash — restore or delete permanently first.';
$_lang['goldprice.err_group_not_deleted'] = 'Group is not in trash.';
$_lang['goldprice.err_group_parent_deleted'] = 'Parent weight group is in trash — restore it first.';
$_lang['goldprice.log_group_update'] = 'Weight group "[[+title]]" was updated.';
$_lang['goldprice.log_group_root_create'] = 'Weight group "[[+title]]" was created.';
$_lang['goldprice.log_group_subgroup_create'] = 'Subgroup "[[+title]]" was created.';
$_lang['goldprice.log_group_subgroup_remove'] = 'Subgroup "[[+title]]" was moved to trash.';
$_lang['goldprice.log_group_root_remove'] = 'Weight group "[[+title]]" was moved to trash.';
$_lang['goldprice.log_group_restore'] = 'Group "[[+title]]" was restored from trash.';
$_lang['goldprice.log_group_purge'] = 'Group "[[+title]]" was permanently deleted.';

$_lang['goldprice.price_product'] = 'Product';
$_lang['goldprice.price_weight'] = 'Weight, g';
$_lang['goldprice.price_group'] = 'Group';
$_lang['goldprice.price_group_all'] = 'All groups';

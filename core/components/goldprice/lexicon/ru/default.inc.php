...
$_lang['goldprice.field_subgroup'] = 'Подгруппа (серия)';
$_lang['goldprice.field_subgroup_help'] = 'Необязательно. Дельта наценок к выбранной весовой группе.';
...
$_lang['goldprice.tab_groups_intro'] = 'Весовые группы и подгруппы-серии. У подгруппы редактируются только дельты наценок. После изменения цены пересчитываются.';
...
$_lang['goldprice.tab_trash'] = 'Корзина';
$_lang['goldprice.tab_trash_intro'] = 'Удалённые весовые группы и подгруппы. Восстановление или окончательное удаление.';
...
$_lang['goldprice.group_add_to_parent'] = 'Прибавлять к наценкам весовой группы';
$_lang['goldprice.group_add_to_parent_desc'] = 'Включено — наценки подгруппы прибавляются к родительской группе, мин. маржа берётся от родителя. Выключено — у подгруппы свои полные наценки и мин. маржа.';
$_lang['goldprice.group_parent'] = 'Весовая группа';
$_lang['goldprice.group_root_create'] = 'Добавить весовую группу';
$_lang['goldprice.group_subgroup_create'] = 'Добавить подгруппу';
$_lang['goldprice.group_root_update'] = 'Изменить весовую группу';
$_lang['goldprice.group_subgroup_update'] = 'Изменить подгруппу';
$_lang['goldprice.group_copy'] = 'Копировать';
$_lang['goldprice.group_copy_suffix'] = ' (копия)';
$_lang['goldprice.group_remove'] = 'Удалить';
$_lang['goldprice.group_subgroup_remove'] = 'Удалить подгруппу';
$_lang['goldprice.group_subgroup_remove_confirm'] = 'Товары этой подгруппы будут переведены на родительскую весовую группу. Удалить подгруппу?';
$_lang['goldprice.group_root_remove_confirm'] = 'Весовая группа, её подгруппы и товары в них будут отправлены в корзину. Товары останутся без группы. Удалить?';
$_lang['goldprice.group_deleted_at'] = 'Удалено';
$_lang['goldprice.group_restore'] = 'Восстановить';
$_lang['goldprice.group_restore_confirm'] = 'Восстановить эту группу? Для весовой группы также восстановятся удалённые подгруппы.';
$_lang['goldprice.group_purge'] = 'Удалить навсегда';
$_lang['goldprice.group_subgroup_purge_confirm'] = 'Подгруппа будет удалена безвозвратно. Товары перейдут на родительскую группу, если она активна. Продолжить?';
$_lang['goldprice.group_root_purge_confirm'] = 'Весовая группа и её подгруппы будут удалены безвозвратно. Товары останутся без группы. Продолжить?';
...
$_lang['goldprice.err_group_parent'] = 'Выберите весовую группу для подгруппы.';
$_lang['goldprice.err_group_remove_root'] = 'Нельзя удалить весовую группу.';
$_lang['goldprice.err_group_deleted'] = 'Группа в корзине — сначала восстановите или удалите навсегда.';
$_lang['goldprice.err_group_not_deleted'] = 'Группа не в корзине.';
$_lang['goldprice.err_group_parent_deleted'] = 'Родительская весовая группа в корзине — сначала восстановите её.';
$_lang['goldprice.log_group_update'] = 'Изменена весовая группа «[[+title]]».';
$_lang['goldprice.log_group_root_create'] = 'Добавлена весовая группа «[[+title]]».';
$_lang['goldprice.log_group_subgroup_create'] = 'Добавлена подгруппа «[[+title]]».';
$_lang['goldprice.log_group_subgroup_remove'] = 'В корзину отправлена подгруппа «[[+title]]».';
$_lang['goldprice.log_group_root_remove'] = 'В корзину отправлена весовая группа «[[+title]]».';
$_lang['goldprice.log_group_restore'] = 'Из корзины восстановлена группа «[[+title]]».';
$_lang['goldprice.log_group_purge'] = 'Безвозвратно удалена группа «[[+title]]».';

$_lang['goldprice.price_product'] = 'Товар';
$_lang['goldprice.price_weight'] = 'Вес, г';
$_lang['goldprice.price_group'] = 'Группа';
$_lang['goldprice.price_group_all'] = 'Все группы';
